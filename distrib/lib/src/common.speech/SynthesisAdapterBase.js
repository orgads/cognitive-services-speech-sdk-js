...
var SynthesisAdapterBase = /** @class */ (function () {
    ...
    SynthesisAdapterBase.prototype.receiveMessage = function () {
        return __awaiter(this, void 0, void 0, function () {
            var connection, message, connectionMessage, _a, audioWithHeader, ev, metadataList, _i, metadataList_1, metadata, ev, result, audioBuffer, error_1, e_2;
                    ...
                    case 6:
                        ...
                        for (_i = 0, metadataList_1 = metadataList; _i < metadataList_1.length; _i++) {
                            ...
                            if (metadata.Type.toLowerCase() === "WordBoundary".toLowerCase()) {
                                ...
                                ev = new Exports_2.SpeechSynthesisWordBoundaryEventArgs(metadata.Data.Offset, metadata.Data.text.Text, metadata.Data.text.Length, this.privSynthesisTurn.currentTextOffset);
